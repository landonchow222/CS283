...
@test "Seven Pipes" {
    run "./dsh" <<EOF                
echo "Hello World" | tr 'H' '0' | tr 'e' '1' | tr 'l' '2' | tr 'o' '3' | tr 'W' '4' | tr 'r' '5' | tr 'd' '6' 
EOF
    ...
    # Expected output with all whitespace removed for easier matching
    expected_output="0122343526dsh3>dsh3>cmdloopreturned0"
...
@test "Max Commands Error" {
    run "./dsh" <<EOF                
echo "Hello World b" | tr 'H' '0' | tr 'e' '1' | tr 'l' '2' | tr 'o' '3' | tr 'W' '4' | tr 'r' '5' | tr 'd' '6' | tr 'b' '7'
EOF
...
EOF
    ...
    # Expected output with all whitespace removed for easier matching
    expected_output="execvp:Permissiondenieddsh3>dsh3>!!!OperationNotPermitted!!!dsh3>cmdloopreturned8"
